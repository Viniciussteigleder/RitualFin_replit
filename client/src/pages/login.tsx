  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-[#f0f5f0] p-4">
      <Card className="w-full max-w-md shadow-lg border-0 bg-white rounded-2xl">
        <CardContent className="p-8 space-y-6">
          <div className="flex flex-col items-center space-y-2">
            ...
            <span className="font-semibold text-lg text-foreground">RitualFin</span>
          </div>

          <div className="text-center space-y-1">
            <h1 className="text-2xl font-bold text-foreground">Acesse sua conta</h1>
            <p className="text-muted-foreground text-sm">Gerencie suas financas com clareza.</p>
          </div>
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                <Input 
                  ...
                  className="h-12 rounded-xl border-2 bg-white pr-12"
                  value={password}
      ...
      <p className="mt-8 text-sm text-muted-foreground">
        &copy; 2024 RitualFin. Todos os direitos reservados.
      </p>
    </div>
  );
}
