        ...
        <div className="flex flex-col gap-3">
          <div className="flex justify-between items-end">
            <p className="text-sm font-semibold uppercase tracking-wide text-muted-foreground">
              Passo {currentStep} de {totalSteps}: Planejamento
            </p>
            <span className="text-xs text-muted-foreground">{Math.round((currentStep / totalSteps) * 100)}% Concluido</span>
          </div>
          <Progress value={(currentStep / totalSteps) * 100} className="h-2" />
        </div>

        <div>
          <h1 className="text-2xl md:text-3xl font-bold text-foreground">Revisao Guiada Mensal</h1>
          <p className="text-muted-foreground mt-1">
            Vamos planejar o proximo mes? Reveja o que passou e ajuste suas metas para continuar crescendo.
          </p>
        </div>
          ...
          <CardContent className="p-6 md:p-8">
            <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-6">
              <div>
                ...
                <p className="text-muted-foreground mt-1">
                  Copie as metas de {previousMonthName} e ajuste apenas o necessario.
                </p>
              </div>
              <Button 
                  ...
                  <CardContent className="p-5">
                    ...
                    <div className="space-y-1">
                      <Progress 
                        ...
                        className={cn(
                          "h-1.5",
                          cat.status === "exceeded" && "[&>div]:bg-rose-500",
                          cat.status === "warning" && "[&>div]:bg-amber-500"
                        )}
                      />
                      <p className={cn(
