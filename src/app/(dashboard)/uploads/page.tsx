    ...
    <div className="max-w-7xl mx-auto flex flex-col gap-10 pb-32 px-1 font-sans">
       ...
       <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-8 bg-card p-10 rounded-2xl border border-border shadow-sm">
            <div className="flex flex-col gap-3">
             ...
             <div className="flex items-center gap-4 bg-secondary/30 p-4 rounded-2xl border border-border shadow-inner px-6">
                ...
                <div className="h-3 w-3 bg-emerald-500 rounded-full shadow-[0_0_10px_#10b981]"></div>
            </div>
        </div>
